...
之前，大约2016年的时候，出去面试，无论是大公司 还是创业的小公司，都不可避免问及到算法，甚至要求手写算法。当时就纳闷了，首先在工作中真真不需要使用到算法，而且我还只是一个初级程序员，我感觉我连自己的编程语言都不太熟悉，更别说妄论算法了。但为了应付面试，只能去了解算法，买了一本《算法导论》看，果不其然，，看到想哭，关键是还没学懂，只能无奈放弃。
...
至于这个专栏，我不要你觉得，我要我觉得：王争老师讲的的确好，也是真真的带我入了算法门槛，所以
